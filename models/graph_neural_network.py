...
class GraphGenGnn(nn.Module):
  ...
  def __init__(self, config):
    ...
    self.gne = GraphNodeEmbedding( dim_node_feature      =  self.cf.dim_node_feature   ,
                                   dim_edge_feature      =  self.cf.dim_edge_feature   ,
                                   dim_message           =  128   ,
                                   dim_node_state        =  128   ,
                                   dim_hidden_input      =  128   ,
                                   dim_hidden_readout    =  128   ,
                                   dim_hidden_attention  =  128   ,
                                   dim_readout           =  self.cf.dim_node_feature   ,
                                   num_layer             =  7     ,
